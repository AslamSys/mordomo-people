...
OPENCLAW_PROVIDERS = {
    ...
    "anthropic": {"name": "Anthropic", "baseUrl": "https://api.anthropic.com",     "models": ["claude-sonnet-4-20250514", "claude-3.5-sonnet-20241022", "claude-3-haiku-20240307"]},
    "groq":      {"name": "Groq",      "baseUrl": "https://api.groq.com/openai/v1", "models": ["llama-3.3-70b-versatile", "llama-3.1-8b-instant", "gemma2-9b-it"]},
    "google":    {"name": "Google",    "baseUrl": "https://generativelanguage.googleapis.com/v1beta", "models": ["gemini-2.5-flash", "gemini-2.5-pro"]},
}
